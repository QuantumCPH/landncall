...
<?php if($wrap_content): ?>
	...
	<p>
	<?php echo __('Thank you for ordering <b>%1%</b> and becoming SmarSim Customer. We welcome you to a new and huge mobile world.', array('%1%'=>$order->getProduct()->getName())) ?> Ditt kundnummer &auml;r  <?php echo $customer->getUniqueid();?>. Det kan du anv&auml;nda i din kontakt med kundservice.
	</p>
