...
<?php if($userguide_list){?>
     <table width="95%" cellspacing="0" cellpadding="2" class="sf_admin_list" border="1" align="center" style="border-collapse: collapse;">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <td width="30px"><a href="<?php echo url_for('userguide/edit?id='.$userguide->getId()) ?>"><?php echo $userguide->getId() ?></a></td>
 ...
 <div id="sf_admin_header" style="padding-top:10px; padding-left: 35px">
