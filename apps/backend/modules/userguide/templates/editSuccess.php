...
<div class="form-row">
  ...
  <a href="http://localhost/landncall_new/web/uploads/documents/<?php echo $qryObj->filename;?>" target="_blank"><strong>Old Document File</strong></a> </div>
</div>
...
<ul class="sf_admin_actions">
  <li><input type="button" onclick="document.location.href='../client_documents';" value="list" class="sf_admin_action_list"></li>
