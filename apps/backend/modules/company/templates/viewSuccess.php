<div id="sf_admin_container">
    <div id="sf_admin_content">
        ...
        <a href="<?php echo url_for('employee/index') . '?company_id=' . $company->getId() . "&filter=filter" ?>" class="external_link" target="_self">Employees (<?php echo count($employeeCount) ?>)</a>
