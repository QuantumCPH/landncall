...
//     die;
    ...
    public function executeSaveCompanyCallHistoryNotFetch(sfWebRequest $request) {
        ...
        foreach ($callLogs as $callLog) {
            ...
            $tilentaCallHistryResult = CompanyEmployeActivation::callHistory($company, $this->fromdate, $this->todate, false, $callLog->getIService());
//     var_dump($tilentaCallHistryResult);
//     die;
            if ($tilentaCallHistryResult) {
        ...
        foreach ($callLogs as $callLog) {
            ...
            $tilentaCallHistryResult = $tilentaSubscriptionResult = CompanyEmployeActivation::getSubscription($employee, $callLog->getIAccount(), $this->fromdate, $this->todate);
            if ($tilentaCallHistryResult) {
            ...
            if ($count_ta > 0) {
                ...
                foreach ($telinta_accounts as $telinta_account) {
                    ...
                    if (OdrsPeer::doCount($c2) == 0) {
                        ...
                        $tilentaSubscriptionResult = CompanyEmployeActivation::getSubscription($employee, $telinta_account->getIAccount(), $startdate, $enddate);
