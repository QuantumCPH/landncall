...
<form method="post" action="<?php url_for('customer/settings') ?>" id="settingsForm" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
  <div class="left-col">
	...
	<div class="split-form">
            ...
            <div class="fl col" style="display:none">
...
*/ ?>
            ...
            <li>
            <label class="required"><?php echo __("Active  Number") ?></label>
 ...
 */ ?>
      ...
      <div class="fr col" style="display:none">
        <ul>
          ...
          <!-- end newsletter -->
          <div>
              <a href="<?php echo url_for('customer/passwordChange') ?>"><?php echo __('Change password') ?></a>
...
<script type="text/javascript">
        ...
        $('.inline-error').css('white-space','nowrap');
</script> 