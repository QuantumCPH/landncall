...
<?php echo $form->renderHiddenFields() ?>
                ...
                <input type="hidden" name="amount" id="" value="<?php echo $total; ?>" />
            ...
            <div class="fr col" style="display: none;">
                ...
                <ul>
                    ...
                    <li id="user_attr_3_field">
                        ...
                        <?php
                        echo $customer_form['auto_refill_min_balance']->render(array(
                            'name' => 'user_attr_3',
                            'id' => 'user_attr_3',
                            'style' => 'width: 80px;'
                        ))
                    ...
                    <li id="user_attr_2_field">
                        ...
                        <?php
                        echo $customer_form['auto_refill_amount']->render(array(
                            'name' => 'user_attr_2',
                            'id' => 'user_attr_2',
                            'style' => 'width:80;',
                            'style' => 'width: 80px;'
