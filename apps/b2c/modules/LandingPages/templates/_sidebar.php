...
<li class="price">Opkald til denne destination er:</li><br />

<li id="lable" class="price"></li><br />
<li id="lable2" class="price"></li><br />
<li class="price">*Du betaler for lokal mobil takst for at ringe til vores hovednummer</li> </ul></div>

		
	</div>
    <div id="langinPageBox">
        <p>Her er din nye globale mobiltelefonløsning.</p>
        <br/>
    <p class="price">Og du skal ikke engang skifte dit abonnement.</p><br/>
    <p class="price">zerOcall global sikrer dig også attraktive priser</p><br/>
    <p class="price">når du er hjemme i Danmark og gerne vil<br/>
    kontakte udlandet.</p><br/>

<p class="price">Når du ringer til udlandet vil zerOcall automatisk</p>
<p class="price">overtage ditopkald og sikre at du kommer</p>

<p class="price">i kontakt med udlandet – og du kan spare helt</p>
<p class="price">op mod 75%. zerOcall sikrer også at du sparer</p>
<p class="price">penge både på dine opkald til/fra Danmark</p>
<p class="price">og de opkald du modtaget i udlandet</p>
    </div>
