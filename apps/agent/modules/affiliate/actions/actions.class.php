...
//    }
    ...
    public function executeSetProductDetailsc(sfWebRequest $request) {
        ...
        unset(
                $this->form['cardno'], $this->form['expmonth'], $this->form['expyear'], $this->form['cvc'], $this->form['cardtype']
        );
...
//exit;
    ...
    public function executeAgentTransaction(sfWebRequest $request) {
        ...
        $notify_url = sfConfig::get('app_url') . 'b2c.php/pScripts/accountRefill?p=' . $callbackparameters;
        ...
        $querystring .= "item_name=" . urlencode("Refill") . "&";
