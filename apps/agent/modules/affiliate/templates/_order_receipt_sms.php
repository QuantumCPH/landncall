...
<?php if($wrap_content): ?>
	...
	<p>
	<?php echo __('Thank you for ordering <b>%1%</b> and becoming SmartSim Customer. We welcome you to a new and huge mobile world.', array('%1%'=>$order->getProduct()->getName())) ?>
	</p>
