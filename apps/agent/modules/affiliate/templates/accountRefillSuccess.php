	...
	function checkForm()
	{
		...
		var amounts = document.getElementById("amount").value;
               // alert(amounts);
                ...
                var accepturlstr = "http://landncall.zerocall.com/b2c.php/pScripts/thankyou?accept=yes&subscriptionid=&orderid="+orderids+"&amount="+amounts;
...
<input type="hidden" name="test" value="yes" />
		...
		<input type="hidden" name="status" value="" />
              ...
              <input type="hidden" name="test" value="yes" />
		<input type="hidden" name="cancelurl" value="http://landncall.zerocall.com/b2c.php/pScripts/thankyou/?accept=cancel" />
		<input type="hidden" name="callbackurl" value="http://landncall.zerocall.com/b2c.php/pScripts/accountRefill" />
		<input type="hidden" name="accepturl" id="accepturl"  value="http://landncall.zerocall.com/b2c.php/pScripts/thankyou?accept=yes&subscriptionid=&orderid=<?php echo $agent_order->getAgentOrderId(); ?>&amount=50000">
