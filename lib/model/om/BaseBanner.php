...
abstract class BaseBanner extends BaseObject  implements Persistent {
  ...
  const PEER = 'BannerPeer';
	...
	/**
	 * The value for the banner_name field.
	 * @var        string
	 */
	...
	/**
	 * Get the [banner_name] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [banner_name] column.
	 * 
	 * @param      string $v new value
	 * @return     Banner The current object (for fluent API support)
	 */
	public function setBannerName($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->banner_name !== $v) {
			$this->banner_name = $v;
			$this->modifiedColumns[] = BannerPeer::BANNER_NAME;
		}
	...
	public function setHostId($v)
	{
		...
		if ($this->host_id !== $v) {
			$this->host_id = $v;
			$this->modifiedColumns[] = BannerPeer::HOST_ID;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = BannerPeer::STATUS;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = BannerPeer::CREATED_AT;
			}
	...
	public function setCounter($v)
	{
		...
		if ($this->counter !== $v) {
			$this->counter = $v;
			$this->modifiedColumns[] = BannerPeer::COUNTER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->banner_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->host_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->status = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->created_at = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->counter = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = BannerPeer::NUM_COLUMNS - BannerPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(BannerPeer::CREATED_AT))
    {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getBannerName(),
			$keys[2] => $this->getHostId(),
			$keys[3] => $this->getStatus(),
			$keys[4] => $this->getCreatedAt(),
			$keys[5] => $this->getCounter(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setBannerName($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setHostId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setStatus($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setCreatedAt($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setCounter($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BannerPeer::BANNER_NAME)) $criteria->add(BannerPeer::BANNER_NAME, $this->banner_name);
		if ($this->isColumnModified(BannerPeer::HOST_ID)) $criteria->add(BannerPeer::HOST_ID, $this->host_id);
		if ($this->isColumnModified(BannerPeer::STATUS)) $criteria->add(BannerPeer::STATUS, $this->status);
		if ($this->isColumnModified(BannerPeer::CREATED_AT)) $criteria->add(BannerPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(BannerPeer::COUNTER)) $criteria->add(BannerPeer::COUNTER, $this->counter);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBannerName($this->banner_name);
