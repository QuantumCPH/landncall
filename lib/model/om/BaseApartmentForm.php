...
/**
 * Base class that represents a row from the 'apartment_form' table.
 *
 * 
 *
 ...
 */
abstract class BaseApartmentForm extends BaseObject  implements Persistent {


  const PEER = 'ApartmentFormPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ApartmentFormPeer
	 */
	...
	/**
	 * Initializes internal state of BaseApartmentForm object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ApartmentForm The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ApartmentFormPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ApartmentFormPeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ApartmentFormPeer::NUM_COLUMNS - ApartmentFormPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ApartmentForm object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ApartmentFormPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseApartmentForm:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			ApartmentFormPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseApartmentForm:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseApartmentForm:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseApartmentForm:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			ApartmentFormPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ApartmentFormPeer::doInsert($this, $con);
					...
					$affectedRows += ApartmentFormPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ApartmentFormPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ApartmentFormPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ApartmentFormPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
		);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ApartmentFormPeer::ID)) $criteria->add(ApartmentFormPeer::ID, $this->id);
		if ($this->isColumnModified(ApartmentFormPeer::NAME)) $criteria->add(ApartmentFormPeer::NAME, $this->name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ApartmentFormPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ApartmentForm (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ApartmentForm Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ApartmentFormPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ApartmentFormPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this ApartmentForm has previously been saved, it will retrieve
	 * related Companys from storage. If this ApartmentForm is new, it will return
		...
		if ($this->collCompanys === null) {
			if ($this->isNew()) {
			   $this->collCompanys = array();
				...
				$criteria->add(CompanyPeer::APARTMENT_FORM_ID, $this->id);
	 ...
	 * Otherwise if this ApartmentForm is new, it will return
	 * an empty collection; or if this ApartmentForm has previously
	 * been saved, it will retrieve related Companys from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ApartmentForm.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseApartmentForm:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseApartmentForm::%s', $method));
    }
