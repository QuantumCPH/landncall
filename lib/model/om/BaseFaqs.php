...
/**
 * Base class that represents a row from the 'faqs' table.
 *
 * 
 *
 ...
 */
abstract class BaseFaqs extends BaseObject  implements Persistent {
  ...
  const PEER = 'FaqsPeer';
	...
	/**
	 * Initializes internal state of BaseFaqs object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Faqs The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = FaqsPeer::ID;
		}
	...
	public function setQuestion($v)
	{
		...
		if ($this->question !== $v) {
			$this->question = $v;
			$this->modifiedColumns[] = FaqsPeer::QUESTION;
		}
	...
	public function setAnswer($v)
	{
		...
		if ($this->answer !== $v) {
			$this->answer = $v;
			$this->modifiedColumns[] = FaqsPeer::ANSWER;
		}
	...
	public function setCountryId($v)
	{
		...
		if ($this->country_id !== $v) {
			$this->country_id = $v;
			$this->modifiedColumns[] = FaqsPeer::COUNTRY_ID;
		}
	...
	public function setStatusId($v)
	{
		...
		if ($this->status_id !== $v) {
			$this->status_id = $v;
			$this->modifiedColumns[] = FaqsPeer::STATUS_ID;
		}
	...
	public function setCreateAt($v)
	{
		...
		if ( $this->create_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = FaqsPeer::CREATE_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = FaqsPeer::NUM_COLUMNS - FaqsPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Faqs object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = FaqsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseFaqs:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseFaqs:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseFaqs:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseFaqs:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			FaqsPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += FaqsPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FaqsPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FaqsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FaqsPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FaqsPeer::ID)) $criteria->add(FaqsPeer::ID, $this->id);
		if ($this->isColumnModified(FaqsPeer::QUESTION)) $criteria->add(FaqsPeer::QUESTION, $this->question);
		if ($this->isColumnModified(FaqsPeer::ANSWER)) $criteria->add(FaqsPeer::ANSWER, $this->answer);
		if ($this->isColumnModified(FaqsPeer::COUNTRY_ID)) $criteria->add(FaqsPeer::COUNTRY_ID, $this->country_id);
		if ($this->isColumnModified(FaqsPeer::STATUS_ID)) $criteria->add(FaqsPeer::STATUS_ID, $this->status_id);
		if ($this->isColumnModified(FaqsPeer::CREATE_AT)) $criteria->add(FaqsPeer::CREATE_AT, $this->create_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FaqsPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Faqs (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Faqs Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getEnableCountry(PropelPDO $con = null)
	{
		if ($this->aEnableCountry === null && ($this->country_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aEnableCountry->addFaqss($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseFaqs:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseFaqs::%s', $method));
    }
