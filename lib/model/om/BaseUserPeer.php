...
abstract class BaseUserPeer {
	...
	const IS_SUPER_USER = 'user.IS_SUPER_USER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Email', 'Password', 'RoleId', 'IsSuperUser', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'email', 'password', 'roleId', 'isSuperUser', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::EMAIL, self::PASSWORD, self::ROLE_ID, self::IS_SUPER_USER, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'email', 'password', 'role_id', 'is_super_user', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Email' => 2, 'Password' => 3, 'RoleId' => 4, 'IsSuperUser' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'password' => 3, 'roleId' => 4, 'isSuperUser' => 5, 'createdAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::EMAIL => 2, self::PASSWORD => 3, self::ROLE_ID => 4, self::IS_SUPER_USER => 5, self::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'password' => 3, 'role_id' => 4, 'is_super_user' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::IS_SUPER_USER);
