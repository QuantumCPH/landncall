...
/**
 * Base class that represents a row from the 'invoice_status' table.
 *
 * 
 *
...
abstract class BaseInvoiceStatus extends BaseObject  implements Persistent {
  ...
  const PEER = 'InvoiceStatusPeer';
	...
	/**
	 * Initializes internal state of BaseInvoiceStatus object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     InvoiceStatus The current object (for fluent API support)
	 */
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = InvoiceStatusPeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = InvoiceStatusPeer::NUM_COLUMNS - InvoiceStatusPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = InvoiceStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseInvoiceStatus:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			InvoiceStatusPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(InvoiceStatusPeer::NAME)) $criteria->add(InvoiceStatusPeer::NAME, $this->name);
	 ...
	 * Otherwise if this InvoiceStatus has previously been saved, it will retrieve
	 * related Invoices from storage. If this InvoiceStatus is new, it will return
		...
		if ($this->collInvoices === null) {
			if ($this->isNew()) {
			   $this->collInvoices = array();
				...
				$criteria->add(InvoicePeer::INVOICE_STATUS_ID, $this->id);
	 ...
	 * Otherwise if this InvoiceStatus is new, it will return
	 * an empty collection; or if this InvoiceStatus has previously
	 * been saved, it will retrieve related Invoices from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in InvoiceStatus.
	 */
	public function getInvoicesJoinCompany($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(InvoiceStatusPeer::DATABASE_NAME);
		}
		...
		if ($this->collInvoices === null) {
			if ($this->isNew()) {
				...
				$this->collInvoices = InvoicePeer::doSelectJoinCompany($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
