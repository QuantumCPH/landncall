...
/**
 * Base static class for performing query and update operations on the 'invoice_status' table.
 *
 * 
 *
...
abstract class BaseInvoiceStatusPeer {
	...
	const TABLE_NAME = 'invoice_status';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.InvoiceStatus';
	...
	const ID = 'invoice_status.ID';

	/** the column name for the NAME field */
	const NAME = 'invoice_status.NAME';

	/**
	 * An identiy map to hold any loaded instances of InvoiceStatus objects.
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new InvoiceStatusMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(InvoiceStatusPeer::NAME);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(InvoiceStatusPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = Propel::getConnection(InvoiceStatusPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}


    foreach (sfMixer::getCallables('BaseInvoiceStatusPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseInvoiceStatusPeer', $criteria, $con);
    }
	...
	{
		return InvoiceStatusPeer::populateObjects(InvoiceStatusPeer::doSelectStmt($criteria, $con));
	}
	/**
    ...
    foreach (sfMixer::getCallables('BaseInvoiceStatusPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseInvoiceStatusPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      InvoiceStatus $value A InvoiceStatus object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(InvoiceStatus $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A InvoiceStatus object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof InvoiceStatus) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or InvoiceStatus object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     InvoiceStatus Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = InvoiceStatusPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = InvoiceStatusPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				InvoiceStatusPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseInvoiceStatusPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($con === null) {
			$con = Propel::getConnection(InvoiceStatusPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		if ($criteria->containsKey(InvoiceStatusPeer::ID) && $criteria->keyContainsValue(InvoiceStatusPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.InvoiceStatusPeer::ID.')');
		}
	...
	/**
	 * Method to DELETE all rows from the invoice_status table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			InvoiceStatusPeer::clearInstancePool();

			// rename for clarity
			$criteria = clone $values;
		} elseif ($values instanceof InvoiceStatus) {
			// invalidate the cache for this single object
			InvoiceStatusPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
				...
				InvoiceStatusPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = InvoiceStatusPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the InvoiceStatusPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the InvoiceStatusPeer class:
//
// Propel::getDatabaseMap(InvoiceStatusPeer::DATABASE_NAME)->addTableBuilder(InvoiceStatusPeer::TABLE_NAME, InvoiceStatusPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseInvoiceStatusPeer::DATABASE_NAME)->addTableBuilder(BaseInvoiceStatusPeer::TABLE_NAME, BaseInvoiceStatusPeer::getMapBuilder());
