...
abstract class BaseDevicePeer {
	...
	const MANUFACTURER_ID = 'device.MANUFACTURER_ID';

	/** the column name for the IMAGE_FILE_NAME field */
	const IMAGE_FILE_NAME = 'device.IMAGE_FILE_NAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'ManufacturerId', 'ImageFileName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'manufacturerId', 'imageFileName', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::MANUFACTURER_ID, self::IMAGE_FILE_NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'manufacturer_id', 'image_file_name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'ManufacturerId' => 2, 'ImageFileName' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'manufacturerId' => 2, 'imageFileName' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::MANUFACTURER_ID => 2, self::IMAGE_FILE_NAME => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'manufacturer_id' => 2, 'image_file_name' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(DevicePeer::MANUFACTURER_ID);

		$criteria->addSelectColumn(DevicePeer::IMAGE_FILE_NAME);
    ...
    foreach (sfMixer::getCallables('BaseDevicePeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseDevicePeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseDevicePeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseDevicePeer', $criteria, $con);
    }
	...
	public static function doCountJoinManufacturer(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(DevicePeer::MANUFACTURER_ID,), array(ManufacturerPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Device objects pre-filled with their Manufacturer objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseDevicePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseDevicePeer', $c, $con);
    }
		...
		$c->addJoin(array(DevicePeer::MANUFACTURER_ID,), array(ManufacturerPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Device) to $obj2 (Manufacturer)
				$obj2->addDevice($obj1);
    ...
    foreach (sfMixer::getCallables('BaseDevicePeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseDevicePeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Device) to the collection in $obj2 (Manufacturer)
				$obj2->addDevice($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseDevicePeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseDevicePeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseDevicePeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseDevicePeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseDevicePeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseDevicePeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseDevicePeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseDevicePeer', $values, $con, $ret);
    }
...
//
// NOTE: This static code cannot call methods on the DevicePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the DevicePeer class:
//
// Propel::getDatabaseMap(DevicePeer::DATABASE_NAME)->addTableBuilder(DevicePeer::TABLE_NAME, DevicePeer::getMapBuilder());
//
