  ...
  const PEER = 'CompanyPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->rate_table_id = ($row[$startcol + 31] !== null) ? (int) $row[$startcol + 31] : null;
			$this->resetModified();
			...
			return $startcol + 32; // 32 = CompanyPeer::NUM_COLUMNS - CompanyPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[31], $arr)) $this->setRateTableId($arr[$keys[31]]);
	}
