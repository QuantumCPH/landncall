...
abstract class BaseCustomerType extends BaseObject  implements Persistent {
  ...
  const PEER = 'CustomerTypePeer';
	...
	/**
	 * Initializes internal state of BaseCustomerType object.
	 * @see        applyDefaults()
	 */
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = CustomerTypePeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = CustomerTypePeer::NUM_COLUMNS - CustomerTypePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CustomerTypePeer::NAME)) $criteria->add(CustomerTypePeer::NAME, $this->name);
	 ...
	 * Otherwise if this CustomerType has previously been saved, it will retrieve
	 * related Companys from storage. If this CustomerType is new, it will return
		...
		if ($this->collCompanys === null) {
			if ($this->isNew()) {
			   $this->collCompanys = array();
				...
				$criteria->add(CompanyPeer::CUSTOMER_TYPE_ID, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCustomerType:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCustomerType::%s', $method));
    }
