...
abstract class BaseOrderStatusPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new OrderStatusMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseOrderStatusPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseOrderStatusPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseOrderStatusPeer', $criteria, $con);
    }
	 ...
	 *
	 * @param      OrderStatus $value A OrderStatus object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(OrderStatus $obj, $key = null)
	{
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the order_status table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
...
//
// NOTE: This static code cannot call methods on the OrderStatusPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the OrderStatusPeer class:
//
// Propel::getDatabaseMap(OrderStatusPeer::DATABASE_NAME)->addTableBuilder(OrderStatusPeer::TABLE_NAME, OrderStatusPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseOrderStatusPeer::DATABASE_NAME)->addTableBuilder(BaseOrderStatusPeer::TABLE_NAME, BaseOrderStatusPeer::getMapBuilder());
