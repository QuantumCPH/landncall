...
/**
 * Base class that represents a row from the 'entity_status' table.
 *
 * 
 *
 ...
 */
abstract class BaseEntityStatus extends BaseObject  implements Persistent {


  const PEER = 'EntityStatusPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        EntityStatusPeer
	 */
	...
	/**
	 * Initializes internal state of BaseEntityStatus object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     EntityStatus The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = EntityStatusPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = EntityStatusPeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = EntityStatusPeer::NUM_COLUMNS - EntityStatusPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating EntityStatus object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = EntityStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseEntityStatus:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			EntityStatusPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseEntityStatus:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseEntityStatus:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseEntityStatus:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			EntityStatusPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = EntityStatusPeer::doInsert($this, $con);
					...
					$affectedRows += EntityStatusPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = EntityStatusPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = EntityStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = EntityStatusPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
		);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EntityStatusPeer::ID)) $criteria->add(EntityStatusPeer::ID, $this->id);
		if ($this->isColumnModified(EntityStatusPeer::NAME)) $criteria->add(EntityStatusPeer::NAME, $this->name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(EntityStatusPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of EntityStatus (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     EntityStatus Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     EntityStatusPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new EntityStatusPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this EntityStatus has previously been saved, it will retrieve
	 * related Customers from storage. If this EntityStatus is new, it will return
		...
		if ($this->collCustomers === null) {
			if ($this->isNew()) {
			   $this->collCustomers = array();
				...
				$criteria->add(CustomerPeer::CUSTOMER_STATUS_ID, $this->id);
	 ...
	 * Otherwise if this EntityStatus is new, it will return
	 * an empty collection; or if this EntityStatus has previously
	 * been saved, it will retrieve related Customers from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in EntityStatus.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this EntityStatus has previously been saved, it will retrieve
	 * related CustomerOrders from storage. If this EntityStatus is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCustomerOrders === null) {
			if ($this->isNew()) {
			   $this->collCustomerOrders = array();
				...
				$criteria->add(CustomerOrderPeer::ORDER_STATUS_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this EntityStatus has previously been saved, it will retrieve
	 * related Transactions from storage. If this EntityStatus is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTransactions === null) {
			if ($this->isNew()) {
			   $this->collTransactions = array();
				...
				$criteria->add(TransactionPeer::TRANSACTION_STATUS_ID, $this->id);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseEntityStatus:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseEntityStatus::%s', $method));
    }
