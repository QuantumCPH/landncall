...
abstract class BaseCountryPeer {
	...
	const CALLING_CODE = 'country.CALLING_CODE';

	/** the column name for the CBF_RATE field */
	const CBF_RATE = 'country.CBF_RATE';

	/** the column name for the TAISYS_RATE field */
	const TAISYS_RATE = 'country.TAISYS_RATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Code', 'CallingCode', 'CbfRate', 'TaisysRate', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'code', 'callingCode', 'cbfRate', 'taisysRate', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CODE, self::CALLING_CODE, self::CBF_RATE, self::TAISYS_RATE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'code', 'calling_code', 'cbf_rate', 'taisys_rate', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Code' => 2, 'CallingCode' => 3, 'CbfRate' => 4, 'TaisysRate' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'code' => 2, 'callingCode' => 3, 'cbfRate' => 4, 'taisysRate' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CODE => 2, self::CALLING_CODE => 3, self::CBF_RATE => 4, self::TAISYS_RATE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'code' => 2, 'calling_code' => 3, 'cbf_rate' => 4, 'taisys_rate' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CountryPeer::CALLING_CODE);

		$criteria->addSelectColumn(CountryPeer::CBF_RATE);

		$criteria->addSelectColumn(CountryPeer::TAISYS_RATE);
  ...
  static public function getUniqueColumnNames()
  {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(CityPeer::COUNTRY_ID, $obj->getId());
			$affectedRows += CityPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria->add(CompanyPeer::COUNTRY_ID, $obj->getId());
			$updateValues->add(CompanyPeer::COUNTRY_ID, null);
