...
abstract class BaseCityPeer {
	...
	public static function doCountJoinCountry(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(CityPeer::COUNTRY_ID,), array(CountryPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseCityPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseCityPeer', $c, $con);
		...
		$c->addJoin(array(CityPeer::COUNTRY_ID,), array(CountryPeer::ID,), $join_behavior);
  ...
  static public function getUniqueColumnNames()
  {
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria->add(CompanyPeer::CITY_ID, $obj->getId());
			$updateValues->add(CompanyPeer::CITY_ID, null);
