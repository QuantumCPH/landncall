...
abstract class BaseHost extends BaseObject  implements Persistent {
  ...
  const PEER = 'HostPeer';
	...
	public function setHostName($v)
	{
		...
		if ($this->host_name !== $v) {
			$this->host_name = $v;
			$this->modifiedColumns[] = HostPeer::HOST_NAME;
		}
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = HostPeer::URL;
		}
	...
	public function setStartDate($v)
	{
		...
		if ( $this->start_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = HostPeer::START_DATE;
			}
		} // if either are not null
	...
	public function setEndDate($v)
	{
		...
		if ( $this->end_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = HostPeer::END_DATE;
			}
		} // if either are not null
	...
	public function setCounter($v)
	{
		...
		if ($this->counter !== $v) {
			$this->counter = $v;
			$this->modifiedColumns[] = HostPeer::COUNTER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->host_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			$this->counter = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = HostPeer::NUM_COLUMNS - HostPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setCounter($arr[$keys[7]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(HostPeer::HOST_NAME)) $criteria->add(HostPeer::HOST_NAME, $this->host_name);
		...
		if ($this->isColumnModified(HostPeer::URL)) $criteria->add(HostPeer::URL, $this->url);
		if ($this->isColumnModified(HostPeer::START_DATE)) $criteria->add(HostPeer::START_DATE, $this->start_date);
		if ($this->isColumnModified(HostPeer::END_DATE)) $criteria->add(HostPeer::END_DATE, $this->end_date);
		if ($this->isColumnModified(HostPeer::COUNTER)) $criteria->add(HostPeer::COUNTER, $this->counter);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseHost:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseHost::%s', $method));
    }
