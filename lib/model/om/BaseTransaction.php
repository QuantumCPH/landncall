...
abstract class BaseTransaction extends BaseObject  implements Persistent {
  ...
  const PEER = 'TransactionPeer';
	...
	public function ensureConsistency()
	{
		...
		if ($this->aEntityStatus !== null && $this->transaction_status_id !== $this->aEntityStatus->getId()) {
			$this->aEntityStatus = null;
		}
	} // ensureConsistency
	...
	{
		if ($this->aEntityStatus === null && ($this->transaction_status_id !== null)) {
			$c = new Criteria(EntityStatusPeer::DATABASE_NAME);
			$c->add(EntityStatusPeer::ID, $this->transaction_status_id);
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEntityStatus->addTransactions($this);
			 */
		}
