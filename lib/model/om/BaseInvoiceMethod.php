...
/**
 * Base class that represents a row from the 'invoice_method' table.
 *
 * 
 *
 ...
 */
abstract class BaseInvoiceMethod extends BaseObject  implements Persistent {


  const PEER = 'InvoiceMethodPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        InvoiceMethodPeer
	 */
	...
	/**
	 * The value for the billingdays field.
	 * @var        int
	 */
	protected $billingdays;
	...
	/**
	 * Initializes internal state of BaseInvoiceMethod object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [billingdays] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     InvoiceMethod The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = InvoiceMethodPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = InvoiceMethodPeer::NAME;
		}
	...
	public function setCost($v)
	{
		...
		if ($this->cost !== $v || $v === 0) {
			$this->cost = $v;
			$this->modifiedColumns[] = InvoiceMethodPeer::COST;
		}
	...
	/**
	 * Set the value of [billingdays] column.
	 * 
	 * @param      int $v new value
	 * @return     InvoiceMethod The current object (for fluent API support)
	 */
	public function setBillingdays($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->billingdays !== $v) {
			$this->billingdays = $v;
			$this->modifiedColumns[] = InvoiceMethodPeer::BILLINGDAYS;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(InvoiceMethodPeer::COST))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cost = ($row[$startcol + 2] !== null) ? (double) $row[$startcol + 2] : null;
			$this->billingdays = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = InvoiceMethodPeer::NUM_COLUMNS - InvoiceMethodPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating InvoiceMethod object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = InvoiceMethodPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseInvoiceMethod:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			InvoiceMethodPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseInvoiceMethod:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseInvoiceMethod:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseInvoiceMethod:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			InvoiceMethodPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = InvoiceMethodPeer::doInsert($this, $con);
					...
					$affectedRows += InvoiceMethodPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = InvoiceMethodPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = InvoiceMethodPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = InvoiceMethodPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getCost(),
			$keys[3] => $this->getBillingdays(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setBillingdays($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(InvoiceMethodPeer::ID)) $criteria->add(InvoiceMethodPeer::ID, $this->id);
		if ($this->isColumnModified(InvoiceMethodPeer::NAME)) $criteria->add(InvoiceMethodPeer::NAME, $this->name);
		if ($this->isColumnModified(InvoiceMethodPeer::COST)) $criteria->add(InvoiceMethodPeer::COST, $this->cost);
		if ($this->isColumnModified(InvoiceMethodPeer::BILLINGDAYS)) $criteria->add(InvoiceMethodPeer::BILLINGDAYS, $this->billingdays);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(InvoiceMethodPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of InvoiceMethod (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBillingdays($this->billingdays);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     InvoiceMethod Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     InvoiceMethodPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new InvoiceMethodPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this InvoiceMethod has previously been saved, it will retrieve
	 * related Companys from storage. If this InvoiceMethod is new, it will return
		...
		if ($this->collCompanys === null) {
			if ($this->isNew()) {
			   $this->collCompanys = array();
				...
				$criteria->add(CompanyPeer::INVOICE_METHOD_ID, $this->id);
	 ...
	 * Otherwise if this InvoiceMethod is new, it will return
	 * an empty collection; or if this InvoiceMethod has previously
	 * been saved, it will retrieve related Companys from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in InvoiceMethod.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseInvoiceMethod:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseInvoiceMethod::%s', $method));
    }
