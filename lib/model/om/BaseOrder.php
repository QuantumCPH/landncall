  ...
  const PEER = 'OrderPeer';
	...
	public function setQuantity($v)
	{
		...
		if ($this->quantity !== $v || $v === 1) {
			$this->quantity = $v;
			$this->modifiedColumns[] = OrderPeer::QUANTITY;
		}
	...
	public function setExtraRefill($v)
	{
		...
		if ($this->extra_refill !== $v || $v === 0) {
			$this->extra_refill = $v;
			$this->modifiedColumns[] = OrderPeer::EXTRA_REFILL;
		}
	...
	public function setIsFirstOrder($v)
	{
		...
		if ($this->is_first_order !== $v || $v === 0) {
			$this->is_first_order = $v;
			$this->modifiedColumns[] = OrderPeer::IS_FIRST_ORDER;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(OrderPeer::QUANTITY,OrderPeer::ORDER_STATUS_ID,OrderPeer::EXTRA_REFILL,OrderPeer::IS_FIRST_ORDER))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_first_order = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = OrderPeer::NUM_COLUMNS - OrderPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OrderPeer::QUANTITY)) $criteria->add(OrderPeer::QUANTITY, $this->quantity);
		...
		if ($this->isColumnModified(OrderPeer::EXTRA_REFILL)) $criteria->add(OrderPeer::EXTRA_REFILL, $this->extra_refill);
		...
		if ($this->isColumnModified(OrderPeer::IS_FIRST_ORDER)) $criteria->add(OrderPeer::IS_FIRST_ORDER, $this->is_first_order);
	...
	public function getEntityStatus(PropelPDO $con = null)
	{
		if ($this->aEntityStatus === null && ($this->order_status_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEntityStatus->addOrders($this);
			 */
		}
	 ...
	 * Otherwise if this Order has previously been saved, it will retrieve
	 * related Transactions from storage. If this Order is new, it will return
