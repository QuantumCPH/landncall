...
abstract class BaseOrderStatus extends BaseObject  implements Persistent {
  ...
  const PEER = 'OrderStatusPeer';
	...
	/**
	 * Initializes internal state of BaseOrderStatus object.
	 * @see        applyDefaults()
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = OrderStatusPeer::NUM_COLUMNS - OrderStatusPeer::NUM_LAZY_LOAD_COLUMNS).
