...
/**
 * Base class that represents a row from the 'support_issue' table.
 *
 * 
 *
 ...
 */
abstract class BaseSupportIssue extends BaseObject  implements Persistent {


  const PEER = 'SupportIssuePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        SupportIssuePeer
	 */
	...
	/**
	 * Initializes internal state of BaseSupportIssue object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     SupportIssue The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SupportIssuePeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = SupportIssuePeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = SupportIssuePeer::NUM_COLUMNS - SupportIssuePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SupportIssue object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SupportIssuePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseSupportIssue:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			SupportIssuePeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseSupportIssue:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseSupportIssue:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseSupportIssue:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			SupportIssuePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SupportIssuePeer::doInsert($this, $con);
					...
					$affectedRows += SupportIssuePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SupportIssuePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SupportIssuePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SupportIssuePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
		);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SupportIssuePeer::ID)) $criteria->add(SupportIssuePeer::ID, $this->id);
		if ($this->isColumnModified(SupportIssuePeer::NAME)) $criteria->add(SupportIssuePeer::NAME, $this->name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SupportIssuePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SupportIssue (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SupportIssue Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SupportIssuePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SupportIssuePeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this SupportIssue has previously been saved, it will retrieve
	 * related SupportActivitys from storage. If this SupportIssue is new, it will return
		...
		if ($this->collSupportActivitys === null) {
			if ($this->isNew()) {
			   $this->collSupportActivitys = array();
				...
				$criteria->add(SupportActivityPeer::SUPPORT_ISSUE_ID, $this->id);
	 ...
	 * Otherwise if this SupportIssue is new, it will return
	 * an empty collection; or if this SupportIssue has previously
	 * been saved, it will retrieve related SupportActivitys from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in SupportIssue.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseSupportIssue:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseSupportIssue::%s', $method));
    }
