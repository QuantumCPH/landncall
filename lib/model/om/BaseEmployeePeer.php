...
abstract class BaseEmployeePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CompanyId', 'FirstName', 'LastName', 'Email', 'MobileModel', 'MobileNumber', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'companyId', 'firstName', 'lastName', 'email', 'mobileModel', 'mobileNumber', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::COMPANY_ID, self::FIRST_NAME, self::LAST_NAME, self::EMAIL, self::MOBILE_MODEL, self::MOBILE_NUMBER, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'company_id', 'first_name', 'last_name', 'email', 'mobile_model', 'mobile_number', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CompanyId' => 1, 'FirstName' => 2, 'LastName' => 3, 'Email' => 4, 'MobileModel' => 5, 'MobileNumber' => 6, 'CreatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'companyId' => 1, 'firstName' => 2, 'lastName' => 3, 'email' => 4, 'mobileModel' => 5, 'mobileNumber' => 6, 'createdAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::COMPANY_ID => 1, self::FIRST_NAME => 2, self::LAST_NAME => 3, self::EMAIL => 4, self::MOBILE_MODEL => 5, self::MOBILE_NUMBER => 6, self::CREATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'company_id' => 1, 'first_name' => 2, 'last_name' => 3, 'email' => 4, 'mobile_model' => 5, 'mobile_number' => 6, 'created_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
