...
abstract class BaseCity extends BaseObject  implements Persistent {
  ...
  const PEER = 'CityPeer';
	 ...
	 * related AgentCompanys from storage. If this City is new, it will return
		...
		if ($this->collAgentCompanys === null) {
			if ($this->isNew()) {
			   $this->collAgentCompanys = array();
				...
				$criteria->add(AgentCompanyPeer::CITY_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this City has previously been saved, it will retrieve
	 * related Companys from storage. If this City is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collCompanys === null) {
			if ($this->isNew()) {
			   $this->collCompanys = array();
				...
				$criteria->add(CompanyPeer::CITY_ID, $this->id);
