...
/**
 * Base class that represents a row from the 'usage_alert_sender' table.
 *
 * 
 *
 ...
 */
abstract class BaseUsageAlertSender extends BaseObject  implements Persistent {


  const PEER = 'UsageAlertSenderPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        UsageAlertSenderPeer
	 */
	...
	/**
	 * Initializes internal state of BaseUsageAlertSender object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     UsageAlertSender The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = UsageAlertSenderPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = UsageAlertSenderPeer::NAME;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = UsageAlertSenderPeer::STATUS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = UsageAlertSenderPeer::NUM_COLUMNS - UsageAlertSenderPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating UsageAlertSender object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UsageAlertSenderPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseUsageAlertSender:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			UsageAlertSenderPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseUsageAlertSender:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseUsageAlertSender:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseUsageAlertSender:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			UsageAlertSenderPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = UsageAlertSenderPeer::doInsert($this, $con);
					...
					$affectedRows += UsageAlertSenderPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UsageAlertSenderPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = UsageAlertSenderPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = UsageAlertSenderPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsageAlertSenderPeer::ID)) $criteria->add(UsageAlertSenderPeer::ID, $this->id);
		if ($this->isColumnModified(UsageAlertSenderPeer::NAME)) $criteria->add(UsageAlertSenderPeer::NAME, $this->name);
		if ($this->isColumnModified(UsageAlertSenderPeer::STATUS)) $criteria->add(UsageAlertSenderPeer::STATUS, $this->status);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(UsageAlertSenderPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UsageAlertSender (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UsageAlertSender Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     UsageAlertSenderPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new UsageAlertSenderPeer();
		}
		return self::$peer;
	}
	...
	public function getStatusRelatedByStatus(PropelPDO $con = null)
	{
		if ($this->aStatusRelatedByStatus === null && ($this->status !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aStatusRelatedByStatus->addUsageAlertSenders($this);
			 */
		}
	 ...
	 * Otherwise if this UsageAlertSender has previously been saved, it will retrieve
	 * related UsageAlerts from storage. If this UsageAlertSender is new, it will return
		...
		if ($this->collUsageAlerts === null) {
			if ($this->isNew()) {
			   $this->collUsageAlerts = array();
				...
				$criteria->add(UsageAlertPeer::SENDER_NAME, $this->id);
	 ...
	 * Otherwise if this UsageAlertSender is new, it will return
	 * an empty collection; or if this UsageAlertSender has previously
	 * been saved, it will retrieve related UsageAlerts from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in UsageAlertSender.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseUsageAlertSender:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseUsageAlertSender::%s', $method));
    }
