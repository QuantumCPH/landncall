...
abstract class BaseHostPeer {
	...
	const START_DATE = 'host.START_DATE';

	/** the column name for the END_DATE field */
	const END_DATE = 'host.END_DATE';

	/** the column name for the COUNTER field */
	const COUNTER = 'host.COUNTER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'HostName', 'CreatedAt', 'Status', 'Url', 'StartDate', 'EndDate', 'Counter', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'hostName', 'createdAt', 'status', 'url', 'startDate', 'endDate', 'counter', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::HOST_NAME, self::CREATED_AT, self::STATUS, self::URL, self::START_DATE, self::END_DATE, self::COUNTER, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'host_name', 'created_at', 'status', 'url', 'start_date', 'end_date', 'counter', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'HostName' => 1, 'CreatedAt' => 2, 'Status' => 3, 'Url' => 4, 'StartDate' => 5, 'EndDate' => 6, 'Counter' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'hostName' => 1, 'createdAt' => 2, 'status' => 3, 'url' => 4, 'startDate' => 5, 'endDate' => 6, 'counter' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::HOST_NAME => 1, self::CREATED_AT => 2, self::STATUS => 3, self::URL => 4, self::START_DATE => 5, self::END_DATE => 6, self::COUNTER => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'host_name' => 1, 'created_at' => 2, 'status' => 3, 'url' => 4, 'start_date' => 5, 'end_date' => 6, 'counter' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(HostPeer::HOST_NAME);

		$criteria->addSelectColumn(HostPeer::CREATED_AT);

		$criteria->addSelectColumn(HostPeer::STATUS);

		$criteria->addSelectColumn(HostPeer::URL);

		$criteria->addSelectColumn(HostPeer::START_DATE);

		$criteria->addSelectColumn(HostPeer::END_DATE);

		$criteria->addSelectColumn(HostPeer::COUNTER);
    ...
    foreach (sfMixer::getCallables('BaseHostPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseHostPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseHostPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseHostPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseHostPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseHostPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseHostPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseHostPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseHostPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseHostPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseHostPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseHostPeer', $values, $con, $ret);
    }
...
//
// NOTE: This static code cannot call methods on the HostPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the HostPeer class:
//
// Propel::getDatabaseMap(HostPeer::DATABASE_NAME)->addTableBuilder(HostPeer::TABLE_NAME, HostPeer::getMapBuilder());
//
