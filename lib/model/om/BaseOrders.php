...
abstract class BaseOrders extends BaseObject  implements Persistent {
  ...
  const PEER = 'OrdersPeer';
	...
	public function setOId($v)
	{
		...
		if ($this->o_id !== $v) {
			$this->o_id = $v;
			$this->modifiedColumns[] = OrdersPeer::O_ID;
		}
	...
	public function setOrderno($v)
	{
		...
		if ($this->orderno !== $v) {
			$this->orderno = $v;
			$this->modifiedColumns[] = OrdersPeer::ORDERNO;
		}
	...
	public function setPId($v)
	{
		...
		if ($this->p_id !== $v) {
			$this->p_id = $v;
			$this->modifiedColumns[] = OrdersPeer::P_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->o_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->orderno = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->p_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = OrdersPeer::NUM_COLUMNS - OrdersPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setOrderno($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OrdersPeer::O_ID)) $criteria->add(OrdersPeer::O_ID, $this->o_id);
		if ($this->isColumnModified(OrdersPeer::ORDERNO)) $criteria->add(OrdersPeer::ORDERNO, $this->orderno);
		if ($this->isColumnModified(OrdersPeer::P_ID)) $criteria->add(OrdersPeer::P_ID, $this->p_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(OrdersPeer::O_ID, $this->o_id);
	...
	/**
	 * Generic method to set the primary key (o_id column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setOId($this->o_id);

		$copyObj->setOrderno($this->orderno);

		$copyObj->setPId($this->p_id);
