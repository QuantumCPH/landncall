...
/**
 * Base class that represents a row from the 'telecom_operator' table.
 *
 * 
 *
 ...
 */
abstract class BaseTelecomOperator extends BaseObject  implements Persistent {


  const PEER = 'TelecomOperatorPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        TelecomOperatorPeer
	 */
	...
	/**
	 * Initializes internal state of BaseTelecomOperator object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     TelecomOperator The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TelecomOperatorPeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = TelecomOperatorPeer::NAME;
		}
	...
	public function setStatusId($v)
	{
		...
		if ($this->status_id !== $v) {
			$this->status_id = $v;
			$this->modifiedColumns[] = TelecomOperatorPeer::STATUS_ID;
		}
	...
	public function setCountryId($v)
	{
		...
		if ($this->country_id !== $v) {
			$this->country_id = $v;
			$this->modifiedColumns[] = TelecomOperatorPeer::COUNTRY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = TelecomOperatorPeer::NUM_COLUMNS - TelecomOperatorPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating TelecomOperator object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TelecomOperatorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseTelecomOperator:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			TelecomOperatorPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseTelecomOperator:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTelecomOperator:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseTelecomOperator:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			TelecomOperatorPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TelecomOperatorPeer::doInsert($this, $con);
					...
					$affectedRows += TelecomOperatorPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TelecomOperatorPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TelecomOperatorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TelecomOperatorPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TelecomOperatorPeer::ID)) $criteria->add(TelecomOperatorPeer::ID, $this->id);
		if ($this->isColumnModified(TelecomOperatorPeer::NAME)) $criteria->add(TelecomOperatorPeer::NAME, $this->name);
		if ($this->isColumnModified(TelecomOperatorPeer::STATUS_ID)) $criteria->add(TelecomOperatorPeer::STATUS_ID, $this->status_id);
		if ($this->isColumnModified(TelecomOperatorPeer::COUNTRY_ID)) $criteria->add(TelecomOperatorPeer::COUNTRY_ID, $this->country_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TelecomOperatorPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of TelecomOperator (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     TelecomOperator Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TelecomOperatorPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TelecomOperatorPeer();
		}
		return self::$peer;
	}
	...
	public function getStatus(PropelPDO $con = null)
	{
		if ($this->aStatus === null && ($this->status_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aStatus->addTelecomOperators($this);
			 */
		}
		return $this->aStatus;
	}
	...
	public function getEnableCountry(PropelPDO $con = null)
	{
		if ($this->aEnableCountry === null && ($this->country_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aEnableCountry->addTelecomOperators($this);
			 */
		}
	 ...
	 * Otherwise if this TelecomOperator has previously been saved, it will retrieve
	 * related Customers from storage. If this TelecomOperator is new, it will return
		...
		if ($this->collCustomers === null) {
			if ($this->isNew()) {
			   $this->collCustomers = array();
				...
				$criteria->add(CustomerPeer::TELECOM_OPERATOR_ID, $this->id);
	 ...
	 * Otherwise if this TelecomOperator is new, it will return
	 * an empty collection; or if this TelecomOperator has previously
	 * been saved, it will retrieve related Customers from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in TelecomOperator.
	 */
	 ...
	 * actually need in TelecomOperator.
	 */
	public function getCustomersJoinFonetCustomer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TelecomOperatorPeer::DATABASE_NAME);
		}
		...
		if ($this->collCustomers === null) {
			if ($this->isNew()) {
				...
				$this->collCustomers = CustomerPeer::doSelectJoinFonetCustomer($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTelecomOperator:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTelecomOperator::%s', $method));
    }
