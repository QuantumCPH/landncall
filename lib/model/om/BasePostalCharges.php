...
/**
 * Base class that represents a row from the 'postal_charges' table.
 *
 * 
 *
 ...
 */
abstract class BasePostalCharges extends BaseObject  implements Persistent {


  const PEER = 'PostalChargesPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PostalChargesPeer
	 */
	...
	/**
	 * Initializes internal state of BasePostalCharges object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PostalCharges The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PostalChargesPeer::ID;
		}
	...
	public function setCharges($v)
	{
		...
		if ($this->charges !== $v) {
			$this->charges = $v;
			$this->modifiedColumns[] = PostalChargesPeer::CHARGES;
		}
	...
	public function setCountry($v)
	{
		...
		if ($this->country !== $v) {
			$this->country = $v;
			$this->modifiedColumns[] = PostalChargesPeer::COUNTRY;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = PostalChargesPeer::STATUS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->charges = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 4; // 4 = PostalChargesPeer::NUM_COLUMNS - PostalChargesPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PostalCharges object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PostalChargesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BasePostalCharges:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			PostalChargesPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BasePostalCharges:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasePostalCharges:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BasePostalCharges:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			PostalChargesPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PostalChargesPeer::doInsert($this, $con);
					...
					$affectedRows += PostalChargesPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PostalChargesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PostalChargesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PostalChargesPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getCharges(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setCharges($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PostalChargesPeer::ID)) $criteria->add(PostalChargesPeer::ID, $this->id);
		if ($this->isColumnModified(PostalChargesPeer::CHARGES)) $criteria->add(PostalChargesPeer::CHARGES, $this->charges);
		if ($this->isColumnModified(PostalChargesPeer::COUNTRY)) $criteria->add(PostalChargesPeer::COUNTRY, $this->country);
		if ($this->isColumnModified(PostalChargesPeer::STATUS)) $criteria->add(PostalChargesPeer::STATUS, $this->status);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PostalChargesPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PostalCharges (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PostalCharges Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PostalChargesPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PostalChargesPeer();
		}
		return self::$peer;
	}
	...
	public function getEnableCountry(PropelPDO $con = null)
	{
		if ($this->aEnableCountry === null && ($this->country !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aEnableCountry->addPostalChargess($this);
			 */
		}
	...
	public function getStatusRelatedByStatus(PropelPDO $con = null)
	{
		if ($this->aStatusRelatedByStatus === null && ($this->status !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aStatusRelatedByStatus->addPostalChargess($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BasePostalCharges:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BasePostalCharges::%s', $method));
    }
