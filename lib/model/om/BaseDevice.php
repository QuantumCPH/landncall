  ...
  const PEER = 'DevicePeer';
	...
	public function setManufacturerId($v)
	{
		...
		if ($this->manufacturer_id !== $v) {
			...
			$this->modifiedColumns[] = DevicePeer::MANUFACTURER_ID;
		}
	...
	public function setImageFileName($v)
	{
		...
		if ($this->image_file_name !== $v) {
			...
			$this->modifiedColumns[] = DevicePeer::IMAGE_FILE_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->manufacturer_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->image_file_name = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = DevicePeer::NUM_COLUMNS - DevicePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DevicePeer::MANUFACTURER_ID)) $criteria->add(DevicePeer::MANUFACTURER_ID, $this->manufacturer_id);
		if ($this->isColumnModified(DevicePeer::IMAGE_FILE_NAME)) $criteria->add(DevicePeer::IMAGE_FILE_NAME, $this->image_file_name);
	...
	{
		if ($this->aManufacturer === null && (($this->manufacturer_id !== "" && $this->manufacturer_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aManufacturer->addDevices($this);
			 */
		}
	 ...
	 * Otherwise if this Device has previously been saved, it will retrieve
	 * related Customers from storage. If this Device is new, it will return
		...
		if ($this->collCustomers === null) {
			if ($this->isNew()) {
			   $this->collCustomers = array();
				...
				$criteria->add(CustomerPeer::DEVICE_ID, $this->id);
