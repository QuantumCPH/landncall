...
/**
 * Base class that represents a row from the 'activation_code' table.
 *
 * 
 *
...
abstract class BaseActivationCode extends BaseObject  implements Persistent {
  ...
  const PEER = 'ActivationCodePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ActivationCodePeer
	 */
	...
	/**
	 * Initializes internal state of BaseActivationCode object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ActivationCode The current object (for fluent API support)
	 */
	...
	public function setCompanyId($v)
	{
		...
		if ($this->company_id !== $v) {
			$this->company_id = $v;
			$this->modifiedColumns[] = ActivationCodePeer::COMPANY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ActivationCodePeer::NUM_COLUMNS - ActivationCodePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ActivationCodePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseActivationCode:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			ActivationCodePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActivationCodePeer::COMPANY_ID)) $criteria->add(ActivationCodePeer::COMPANY_ID, $this->company_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ActivationCode (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ActivationCode Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getCompany(PropelPDO $con = null)
	{
		if ($this->aCompany === null && ($this->company_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCompany->addActivationCodes($this);
			 */
		}
