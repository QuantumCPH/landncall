...
abstract class BaseVisit extends BaseObject  implements Persistent {
  ...
  const PEER = 'VisitPeer';
	...
	public function setHostId($v)
	{
		...
		if ($this->host_id !== $v) {
			$this->host_id = $v;
			$this->modifiedColumns[] = VisitPeer::HOST_ID;
		}
	...
	public function setBannerId($v)
	{
		...
		if ($this->banner_id !== $v) {
			$this->banner_id = $v;
			$this->modifiedColumns[] = VisitPeer::BANNER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = VisitPeer::NUM_COLUMNS - VisitPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VisitPeer::HOST_ID)) $criteria->add(VisitPeer::HOST_ID, $this->host_id);
		if ($this->isColumnModified(VisitPeer::BANNER_ID)) $criteria->add(VisitPeer::BANNER_ID, $this->banner_id);
