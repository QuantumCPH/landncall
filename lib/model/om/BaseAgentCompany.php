  ...
  const PEER = 'AgentCompanyPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->company_type_id = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
			$this->product_detail = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
			$this->commission_period_id = ($row[$startcol + 16] !== null) ? (int) $row[$startcol + 16] : null;
			$this->account_manager_id = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
			$this->created_at = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
			$this->agent_commission_package_id = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->sms_code = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->is_prepaid = ($row[$startcol + 21] !== null) ? (boolean) $row[$startcol + 21] : null;
			$this->balance = ($row[$startcol + 22] !== null) ? (double) $row[$startcol + 22] : null;
			$this->resetModified();
			...
			return $startcol + 23; // 23 = AgentCompanyPeer::NUM_COLUMNS - AgentCompanyPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[14] => $this->getCompanyTypeId(),
			$keys[15] => $this->getProductDetail(),
			$keys[16] => $this->getCommissionPeriodId(),
			$keys[17] => $this->getAccountManagerId(),
			$keys[18] => $this->getCreatedAt(),
			$keys[19] => $this->getAgentCommissionPackageId(),
			$keys[20] => $this->getSmsCode(),
			$keys[21] => $this->getIsPrepaid(),
			$keys[22] => $this->getBalance(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[14], $arr)) $this->setCompanyTypeId($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setProductDetail($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setCommissionPeriodId($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setAccountManagerId($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setCreatedAt($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setAgentCommissionPackageId($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setSmsCode($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setIsPrepaid($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setBalance($arr[$keys[22]]);
	}
