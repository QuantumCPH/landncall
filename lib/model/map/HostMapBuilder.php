...
/**
 * This class adds structure of 'host' table to 'propel' DatabaseMap object.
 *
 *
...
class HostMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('HOST_NAME', 'HostName', 'VARCHAR', false, 50);

		$tMap->addColumn('CREATED_AT', 'CreatedAt', 'TIMESTAMP', false, null);

		$tMap->addColumn('STATUS', 'Status', 'INTEGER', false, 11);

		$tMap->addColumn('URL', 'Url', 'VARCHAR', false, 75);
