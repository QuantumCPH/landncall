...
class CustomerMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('CUSTOMER_STATUS_ID', 'CustomerStatusId', 'INTEGER', 'entity_status', 'ID', true, 11);

		$tMap->addColumn('ADDRESS', 'Address', 'VARCHAR', true, 255);

		$tMap->addForeignKey('FONET_CUSTOMER_ID', 'FonetCustomerId', 'DOUBLE', 'fonet_customer', 'FONET_CUSTOMER_ID', false, null);
