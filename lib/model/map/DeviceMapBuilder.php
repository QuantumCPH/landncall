...
/**
 * This class adds structure of 'device' table to 'propel' DatabaseMap object.
 *
 *
...
class DeviceMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('MANUFACTURER_ID', 'ManufacturerId', 'BIGINT', 'manufacturer', 'ID', true, 20);

		$tMap->addColumn('IMAGE_FILE_NAME', 'ImageFileName', 'VARCHAR', false, 100);
