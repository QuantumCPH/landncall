...
class SfGuardGroupPermissionMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignPrimaryKey('GROUP_ID', 'GroupId', 'INTEGER' , 'sf_guard_group', 'ID', true, 11);

		$tMap->addForeignPrimaryKey('PERMISSION_ID', 'PermissionId', 'INTEGER' , 'sf_guard_permission', 'ID', true, 11);
