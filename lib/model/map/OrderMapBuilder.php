...
/**
 * This class adds structure of 'order' table to 'propel' DatabaseMap object.
 *
 *
...
class OrderMapBuilder implements MapBuilder {
	...
	{
		$this->dbMap = Propel::getDatabaseMap(OrderPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(OrderPeer::TABLE_NAME);
		$tMap->setPhpName('Order');
		$tMap->setClassname('Order');
		...
		$tMap->addColumn('IS_FIRST_ORDER', 'IsFirstOrder', 'TINYINT', true, 1);
