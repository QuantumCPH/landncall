...
/**
 * Cloud9Data form base class.
 *
 * @package    zapnacrm
 * @subpackage form
 * @author     Your name here
 */
class BaseCloud9DataForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'              => new sfValidatorPropelChoice(array('model' => 'Cloud9Data', 'column' => 'id', 'required' => false)),
